...
|---|----------|----------------|
| 1 | `.claude/features/board.md` (the ANCHOR) | 05 |
| 2 | `.claude/features/TRACKER.md` | 05 |
| 3 | `.claude/features/INDEX.md` | 05 |
| 4 | `.claude/features/PROGRESS.md` | 05 |
| 5 | `.claude/features/backlog/README.md` | 05 |
| 6 | `.claude/agents/task-tracker.md` | 02 |
...
**Stamp gate.** The restamp is verified here too, independently of U5b's own check, because the anchor's stamp IS the staleness signal: **EXECUTE** using Bash tool:
```bash
TARGET="<absolute path resolved in P0>"
