...
| **brewtools** | Text utilities, [SSH](/brewtools/skills/ssh/), [deploy](/brewtools/skills/deploy/), [plugin-update](/brewtools/skills/plugin-update/), manager mode, hook layer: 14 skills, 3 agents, 2 hooks | `claude plugin install brewtools@claude-brewcode` |
