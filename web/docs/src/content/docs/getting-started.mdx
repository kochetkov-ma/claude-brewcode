...
<CardGrid>
  <Card title="brewcode" icon="infinity" href="/brewcode/overview/">
    The core: codebase exploration, quorum review, spec authoring, skill/agent/hook creation. 9 skills · 5 agents · 2 hooks.
  </Card>
...
<CardGrid>
  ...
  <Card title="Skills and agents" icon="settings" href="/brewcode/skills/">
    25 skills and 8 specialized agents across 4 plugins. Built-in tools for
