...
<CardGrid>
  ...
  <Card title="brewdoc" icon="file" href="/brewdoc/overview/">
    Documentation tools: docsync doc-staleness tracking, memory optimization, Markdown → PDF, interactive guide. 6 skills · 0 agents.
  </Card>
</CardGrid>
...
| **brewdoc** | Documentation tools: doc-staleness tracking, generation, memory optimization, PDF conversion | 6 | 0 | — |
