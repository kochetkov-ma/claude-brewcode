...
<CardGrid>
  ...
  <Card title="brewtools" icon="settings" href="/brewtools/overview/">
    Universal utilities: prompt optimization, AI artifact removal, secrets scanning, SSH, deploy, evidence-based debates. 12 skills · 3 agents.
  </Card>
...
| **brewtools** | Text utilities: prompt optimization, AI artifact removal, secrets scanning, SSH, deploy | 12 | 3 | — |
