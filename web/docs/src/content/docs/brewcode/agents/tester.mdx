...
| Triggers | Run tests, analyze failures, debug flaky tests, report issues |
...
| **NO** | Fix production code (->[developer](/brewcode/agents/developer/)), substantial test rewrites (->[developer](/brewcode/agents/developer/)) |
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/agents/tester.md">
