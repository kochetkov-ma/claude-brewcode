...
|-------|------|------|-----|-------|---------|-----|
| `bge-m3` | 1024 | 1.2GB | 1.5GB | Fast | 5/5 | Multilingual (default) |
| `mxbai-embed-large` | 1024 | 670MB | 1GB | Faster | 5/5 | English, max accuracy |
| `nomic-embed-text-v2-moe` | 768 | 500MB | 800MB | Faster | 4/5 | 100+ langs, light |
| `nomic-embed-text` | 768 | 274MB | 500MB | Fastest | 3/5 | Fast, small projects |
...
| `grepai_trace_graph` | Call graph (unreliable w/ SQL) | `symbol`, `depth`, `compact`, `format` |
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/agents/bc-grepai-configurator.md">
