...
Run [text-optimize](/brewtools/skills/text-optimize/) skill on created/updated files before finishing:
```
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/agents/bc-rules-organizer.md">
