...
| Triggers | Phase coordination, knowledge extraction, report verification |
...
| Action | When | Output |
|--------|------|--------|
| **Initialize** | Start of [/brewcode:start](/brewcode/skills/start/) | Validate, create lock, update line 1 status |
...
<Callout type="caution" title="Stop hook dependency">
...
4. **EXTRACT KNOWLEDGE** from report -> append to KNOWLEDGE.jsonl:
   ...
   - Use schema: `{"ts":"ISO","t":"type","txt":"one specific sentence","src":"agent_name"}`
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/agents/bc-coordinator.md">
