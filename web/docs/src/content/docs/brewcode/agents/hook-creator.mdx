---
title: "Hook Creator"
description: "Creates, debugs, and analyzes Claude Code hooks (bash/JS lifecycle event handlers)"
order: 1207
---
...
<Tabs>
  ...
  |-------|:---:|----------|-------|
  | SessionStart | YES | `&lt;system-reminder&gt;` | Stable |
  | UserPromptSubmit | YES | `&lt;system-reminder&gt;` appended | Stable |
  | PreToolUse | YES | `&lt;system-reminder&gt;` | Stable |
  ...
  <TabItem label="Hook Types & Config">
  ...
  **Merge rule:** Hooks from different sources are merged (not overridden). For a single event, ALL registered hooks execute in parallel.
  ...
  <TabItem label="Patterns & Production">
  ...
  <TabItem label="Advanced & Best Practices">
  ...
  <TabItem label="Known Bugs & Versions">
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/agents/hook-creator.md">
