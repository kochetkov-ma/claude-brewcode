...
Subagent spawn constraint: CC 2.1.172 allows nested subagent spawning up to 5 levels deep. Spawn agents from the main conversation when you need their results integrated back into your session.
