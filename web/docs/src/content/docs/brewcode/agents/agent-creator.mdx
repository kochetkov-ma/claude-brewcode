...
order: 1206
---
import { Badge, Callout, Card, CardGrid, Tabs, TabItem } from '../../../../components/mdx';
...
<Tabs>
  ...
  **Auth:** keycloak-js | **Build:** vite
  ...
  6. **Optimize** -- Run [text-optimize](/brewtools/skills/text-optimize/) skill: `Skill(skill="text-optimize", args="path/to/agent.md")`
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/agents/agent-creator.md">
