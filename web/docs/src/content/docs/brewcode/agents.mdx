---
title: "Agents"
description: "All 9 Brewcode agents: models, triggers, tools"
order: 12
---
...
Each agent has its own model, toolset, and system prompt. Brewcode includes 9 agents,
from developer to grepai configuration.
...
:::note[Internal agent]
`bc-grepai-configurator` is internal. It is spawned automatically by the
[/brewcode:grepai](/brewcode/skills/grepai/) skill, is not user-invokable, and has no dedicated page.
:::
...
| **sonnet** | [tester](/brewcode/agents/tester/) | Balanced tasks, review, optimization |

<Callout type="note" title="Moved Agents">
  Agents [text-optimizer](/brewtools/agents/text-optimizer/), [ssh-admin](/brewtools/agents/ssh-admin/), and [deploy-admin](/brewtools/agents/deploy-admin/) live in
