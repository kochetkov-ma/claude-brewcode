---
title: "Agents"
description: "All 14 Brewcode agents: models, triggers, tools"
order: 12
---
...
Each agent has its own model, toolset, and system prompt. Brewcode includes 14 agents,
from developer to deployment and task coordination.
...
| 13 | ssh-admin | opus | Read, Write, Edit, Bash | SSH server administration |
| 14 | deploy-admin | opus | Read, Write, Edit, Bash | GitHub Actions, CI/CD, releases |
...
<CardGrid>
  ...
  <Card title="ssh-admin" icon="terminal" href="/brewcode/agents/ssh-admin/">
    SSH server administration
  </Card>
  <Card title="deploy-admin" icon="sync" href="/brewcode/agents/deploy-admin/">
...
|-------|--------|-------------|
| **opus** | developer, reviewer, architect, skill-creator, agent-creator, hook-creator, bash-expert, bc-grepai-configurator, ssh-admin, deploy-admin | Complex tasks, deep analysis, code generation |
