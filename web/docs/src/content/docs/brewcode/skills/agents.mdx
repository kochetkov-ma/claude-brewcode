...
<CardGrid>
  ...
  <Card title="memory-sync-init" icon="sync" href="/brewdoc/skills/memory-sync-init/">Sibling: generates a project-local sync over memory files, CLAUDE.md, rules — same non-growth rule</Card>
