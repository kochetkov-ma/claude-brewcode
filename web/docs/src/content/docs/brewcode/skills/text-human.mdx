---
title: "Text Human"
description: "Removes AI artifacts, cleans comments, simplifies documentation in code. Use when - humanizing code, removing AI comments, cleaning docs, fixing unicode, making code human-readable."
order: 1111
---
...
```
Task(subagent_type="developer", model="haiku", prompt="...\nBlock 1: [files] [rules] Return JSON")
...
| Unicode bullets | Replace with `-` or `*` |
| Unicode quotes | Replace with `"` or `'` |
...
| Action | Example |
|--------|---------|
| FIX | `# Lane 90001->10001` (fix unicode arrow) |
