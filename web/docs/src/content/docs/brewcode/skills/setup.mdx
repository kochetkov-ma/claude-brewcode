...
<Callout type="tip" title="Automatic">
...
| [Review skill (`/brewcode:review`)](/brewcode/skills/review/) | `.claude/skills/brewcode-review/SKILL.md` |
...
**Plan template:** `.claude/tasks/templates/PLAN.md.template`
**Review skill:** [`.claude/skills/brewcode-review/SKILL.md`](/brewcode/skills/review/)
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/skills/setup">
