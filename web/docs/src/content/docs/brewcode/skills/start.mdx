...
<Steps>
  ...
  <li>
    <div>
      ...
      <p>Reads PLAN.md and KNOWLEDGE.jsonl. Verifies the <code>artifacts/</code> directory exists. The <code>phases/</code> directory is intentionally not read here — phase files are instructions for agents, not the manager.</p>
    </div>
  </li>
  <li>
    <div>
