...
<Steps>
  ...
  <li>
    <div>
      ...
      <p>Spawns 5–10 subagents in a <em>single message</em> — <code>Plan</code>, <code>Explore</code>, and the project's own agents from <code>.claude/agents/</code> — each scoped to one research zone. Agents return findings as bullet lists and file:line references, never large code blocks.</p>
    </div>
  </li>
  <li>
    <div>
...
3. Built-in agent (`Explore`, `Plan`, `general-purpose`)
