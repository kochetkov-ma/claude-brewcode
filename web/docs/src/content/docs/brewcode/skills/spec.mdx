...
| Arguments | `[-n] <description> \| <path-to-requirements>` -- `-n`/`--noask`: no questions to user |
| Model | opus |
| Context | session |
...
> **STOP if MISSING** -- Run [/brewcode:setup](/brewcode/skills/setup/) first.
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/skills/spec">
