...
# Write the specification before writing a single line of code.

<Callout type="caution">
**Skipping spec means rewriting later.** Without a specification (рецепт задачи), parallel agents in `/brewcode:plan` and `/brewcode:start` have no shared ground truth — they duplicate work, contradict each other, and miss edge cases. The fix costs more than the spec would have.
</Callout>
