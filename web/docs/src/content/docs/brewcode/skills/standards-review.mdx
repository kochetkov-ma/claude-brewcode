...
description: "Reviews code for project standards compliance and finds duplicates. Use when - reviewing code quality, checking standards, finding duplicates, analyzing compliance."
order: 1112
---
...
Before reviewing code: identify new utilities/helpers/patterns/abstractions, then search via `grepai_search`, check common locations, and decide based on similarity.
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/skills/standards-review">
