...
<Steps>
  ...
  <li>
    <div>
      ...
      <p>Probes for <code>uv</code> without <code>--yes</code> first. If missing, asks one <code>AskUserQuestion</code> before running <code>brew install uv</code> — a machine-level mutation outside the project, never silent.</p>
    </div>
  </li>
  <li>
    <div>
