...
| Arguments | `[-n] [task-dir\|SPEC.md\|plan-file]` -- `-n`/`--noask`: no questions to user |
| Model | opus |
| Context | session |
...
> **STOP if BOTH locations MISSING for any template** -- Run [/brewcode:setup](/brewcode/skills/setup/) first to get v3 templates.
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewcode/skills/plan">
