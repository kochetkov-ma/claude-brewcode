...
<CardGrid>
  ...
  <Card title="17 skills (recipes)" icon="terminal">
...
<Tabs>
  <TabItem label="Skills">
    17 skills (recipes) cover the full task lifecycle.
...
<Callout type="tip" title="Next steps">
  Check out [Skills](/brewcode/skills/) for detailed descriptions of all 17 skills,
