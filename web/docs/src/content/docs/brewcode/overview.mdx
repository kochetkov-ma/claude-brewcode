...
<Tabs>
  <TabItem label="Skills">
    ...
    | Utilities | grepai, install, teardown, skills, agents | Tools and configuration |
  </TabItem>
...
<Steps>
  ...
  <li class="step step-secondary">
    <div>
      ...
      <p>Create a project-specific agent team with tracking framework. Agents auto-integrate with spec/plan/start.</p>
    </div>
  </li>
</Steps>
