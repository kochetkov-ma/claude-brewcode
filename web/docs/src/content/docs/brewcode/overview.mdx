...
After running [`/brewcode:setup`](/brewcode/skills/setup/) and [`/brewcode:start`](/brewcode/skills/start/), the following appears in your project:
...
<Callout type="tip" title="Next steps">
  Check [Skills](/brewcode/skills/) for detailed descriptions of all 13 skills,
