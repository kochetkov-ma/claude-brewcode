...
<CardGrid>
  ...
  <Card title="15 skills (recipes)" icon="terminal">
  ...
  <Card title="13 agents (brewers)" icon="users">
  ...
  <Card title="Code quality" icon="shield">
    Standards-review, convention analysis, secrets-scan, text-optimize.
...
<Tabs>
  <TabItem label="Skills">
    15 skills (recipes) cover the full task lifecycle.
    See the [Skills](/brewcode/skills/) section for details.

    | Group | Skills | Purpose |
    |-------|--------|---------|
    | Core cycle | setup, spec, plan, start | Task creation and execution |
    | Quality | standards-review, convention, rules, secrets-scan | Code analysis and review |
    | Utilities | grepai, install, teardown, text-optimize, text-human, skills, agents | Tools and configuration |
  </TabItem>
  <TabItem label="Agents">
    13 agents (brewers) with different models and specializations.
...
<Steps>
  <li class="step step-primary">
    <div>
      <strong>Installation</strong> <Badge variant="primary" text="/brewcode:install" />
      <p>Install dependencies: brew, coreutils, jq, optionally grepai.</p>
    </div>
  </li>
  <li class="step step-primary">
    <div>
      <strong>Project setup</strong> <Badge variant="primary" text="/brewcode:setup" />
      <p>Analyze the project and generate adapted templates.</p>
    </div>
  </li>
  <li class="step step-primary">
    <div>
...
<Callout type="tip" title="Next steps">
  Check out [Skills](/brewcode/skills/) for a detailed description of all 15 skills,
