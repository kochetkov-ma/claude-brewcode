...
import { Callout, Steps, Badge, Card, CardGrid } from '../../../../components/mdx';
...
INDEX is stored in JSONL format. Project: `.claude/auto-sync/INDEX.jsonl`. Global: `${BD_PLUGIN_DATA}/auto-sync/INDEX.jsonl` (plugin data dir — `~/.claude/*` is blocked by protected-path policy).
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewdoc/skills/auto-sync">
