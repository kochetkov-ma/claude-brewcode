---
title: "Manager Setup"
description: "Codewords ++m/++rr/++r/++a inject a Manager, review or architecture contract per turn; the opt-in HARD wall blocks main-session writes and forces delegation."
order: 3124
---
...
All five injected blocks were tightened for token efficiency — see [Codewords](#codewords) for what each one now does and [Two rules that do the heavy lifting](#two-rules-that-do-the-heavy-lifting) for the delegation contract they share.
</Callout>
