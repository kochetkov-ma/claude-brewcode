...
**Safety gates are not delegable.** The confirmation gates on release (P4 Step 5) and deploy (P5 Step 4) stay in this skill, in the main conversation — an agent never approves its own push, tag, or dispatch.
