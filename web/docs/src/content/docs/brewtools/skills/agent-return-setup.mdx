...
155 test cases / 803 checks, all passing — `tests/run.sh` in the [skill source](https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewtools/skills/agent-return-setup/tests); run it from a checkout of the repo.
