---
title: "Manager"
description: "Type ++m / ++rr / ++r / ++a anywhere to inject a Manager, review-discipline, or architecture-first directive for one turn. The HARD wall denies Write/Edit/NotebookEdit/WebFetch/MCP-write in the main session, forcing delegation. RU+EN."
order: 3124
---
...
The same find-the-closest-counterpart rule is also injected into generated agents by `/brewcode:teams` and `/brewcode:agents`, gated to agents whose domain writes code, scripts, SQL, schemas, or infra -- see [Teams](/brewcode/skills/teams/) and [Agents](/brewcode/skills/agents/).
...
| `/brewtools:manager edit` | Open the Manager prompt text so you can customize it |
...
| `edit` | `/brewtools:manager edit` | Copy plugin default into project override for editing |
| `reset` | `/brewtools:manager reset` | Delete project override, revert to plugin default |
