...
Model rankings: [SWE-bench Verified leaderboard](https://www.swebench.com/) — Opus 4.7 (87.6%), GPT-5.3 Codex (85%), Gemini 3.1 Pro (80.6%), DeepSeek V4, GLM-5.1, Qwen, MiniMax. Cross-check before switching.
</Callout>
...
<CardGrid>
  <Card title="DeepSeek V4" icon="rocket" href="https://platform.deepseek.com">
    <Badge variant="accent" text="Priority" /> <Badge variant="accent" text="Top open-source SWE-bench" /> <Badge variant="accent" text="Cache verified" /> **deepseek-v4-pro** — 1.6T MoE, 1M context, thinking modes. 90% cache discount, automatic. Alias `claudedeepseek`. No compat flags required. See [SWE-bench leaderboard](https://www.swebench.com/).
  </Card>
