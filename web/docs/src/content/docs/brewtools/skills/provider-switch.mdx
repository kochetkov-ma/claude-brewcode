...
| 4 | DeepSeek V4 Pro | 80.6% | 55.4% | `claudeds` — top open-source |
...
<CardGrid>
  <Card title="DeepSeek V4" icon="rocket" href="https://platform.deepseek.com">
    <Badge variant="accent" text="Priority" /> <Badge variant="accent" text="Top open-source" /> <Badge variant="accent" text="Cache verified" /> **deepseek-v4-pro** — 1.6T MoE, 1M context, thinking modes. SWE-bench Verified 80.6%, Pro 55.4%. 90% cache discount, automatic. Alias `claudeds`. No compat flags. [Leaderboard](https://www.swebench.com/).
  </Card>
