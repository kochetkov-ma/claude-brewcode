...
<CardGrid>
  <Card title="DeepSeek V4" icon="rocket" href="https://platform.deepseek.com">
    <Badge variant="accent" text="Priority" /> **deepseek-v4-pro** — 1.6T MoE, 1M context, thinking modes. Alias `claudedeepseek`. No compat flags required.
  </Card>
...
|----------|:---:|---|---|
| **DeepSeek V4** | Claimed | Unverified | Response surfaces `cache_creation_input_tokens` / `cache_read_input_tokens`. Cache pricing not documented publicly |
