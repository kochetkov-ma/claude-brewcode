...
Target format: `plugin:name` — e.g., `brewdoc:md-to-pdf`, `brewcode:spec`. Name without a plugin prefix triggers a clarifying question before any mutation.
...
/brewtools:skill-toggle disable brewcode:spec --scope=project
