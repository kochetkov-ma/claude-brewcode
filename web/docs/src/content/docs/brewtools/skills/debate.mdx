...
<Steps>
  ...
  <li>
    <div>
      ...
      <p>Status table, outcome (consensus / partial / none), decision bullets, links to all artifacts. Optional <a href="/brewcode/skills/review/"><code>/brewcode:review</code></a> if <code>--review</code> flag was set.</p>
    </div>
  </li>
</Steps>
...
| `--review` | off | Run [`/brewcode:review`](/brewcode/skills/review/) on final output |
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewtools/skills/debate">
