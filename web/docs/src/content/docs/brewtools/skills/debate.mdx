...
<Steps>
  ...
  <li>
    <div>
      ...
      <p>Status table: mode, rounds used, outcome (consensus / partial / none), top 3–5 decision bullets, and links to all four artifact files. If <code>--review</code> was set, triggers a follow-up code review of the decision output.</p>
    </div>
  </li>
</Steps>
...
| 9 — Output | Displays status table; optionally triggers a follow-up code review. |
