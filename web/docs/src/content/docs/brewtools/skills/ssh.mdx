...
**The confirmation gates are not delegable.** DELETE and PRIVILEGE approval happens in Step 3, in the main conversation, *before* any spawn — a subagent never receives an unapproved destructive command.
