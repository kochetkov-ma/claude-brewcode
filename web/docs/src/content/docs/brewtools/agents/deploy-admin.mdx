...
The agent reads `CLAUDE.local.md` in the project root for GitHub config and workflow inventory. This file is populated by the [`/brewtools:deploy`](/brewtools/skills/deploy/) skill.
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewtools/agents/deploy-admin.md">
