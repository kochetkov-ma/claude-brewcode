...
description: "Optimizes text/docs for LLM efficiency. Triggers: optimize prompt, reduce tokens, compress text, too verbose."
order: 3201
---
...
<CardGrid>
  ...
  <Card title="View on GitHub" icon="link" href="https://github.com/kochetkov-ma/claude-brewcode/tree/main/brewtools/agents/text-optimizer.md">
