...
<Steps>
  ...
  <li>
    <div>
      ...
      | Deep | + DICT header (terms used 3+×), symbol substitutions, structural compression | 2–3× |
      | Max (opt-in) | + atomic fact-lines, ASCII operator dialect, format-aware tables, Chain-of-Density pass | 3–4× |
    </div>
  </li>
  <li>
    <div>
      <strong>Verify</strong>
      <p>Verification scales with mode. Dedup-merged facts always count as preserved, never as loss.</p>
...
- Deep — Round 1: read original + compressed side-by-side, list lost/distorted facts, compute semantic match %
...
- Dedup-merged facts always count as preserved (labeled "merged"), never as loss
