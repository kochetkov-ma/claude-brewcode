---
title: "Skills"
description: "All 14 Brewtools skills: commands, parameters, examples, and the -setup naming rule"
order: 31
---
...
Skills (recipes) are slash commands that define *what* to do. Brewtools includes 14 skills
...
<Callout type="tip" title="Standalone">
  All fourteen skills can be used independently -- they require no prior setup
...
| [agent-router-setup](/brewtools/skills/agent-router-setup/) | one mode — a single `brewcode:hook-creator` spawn per mode |
| [context-slim](/brewtools/skills/context-slim/) | one file — a single `text-optimizer` spawn per file, all in one message |
