...
| Providers | 5 (Gemini Imagen 4, OpenRouter Gemini 2.5 Flash, OpenRouter GPT-5, Z.ai CogView-4, OpenAI DALL-E 3) |
...
<CardGrid>
  ...
  <Card title="Z.ai CogView-4" icon="eye">
    Fast, good quality (~$0.015/image). Good for Chinese text rendering. Via Z.ai API.
  </Card>
