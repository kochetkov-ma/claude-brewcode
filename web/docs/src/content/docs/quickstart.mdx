...
<CardGrid>
  <Card title="brewcode" icon="&#x1F3ED;" href="/brewcode/overview/">
    15 skills for development: infinite tasks, review, semantic search,
    skill and agent creation, prompt optimization, secrets scanning.
  </Card>
  <Card title="brewdoc" icon="&#x1F4D7;" href="/brewdoc/overview/">
    4 skills for documentation: automatic sync with the codebase,
    doc generation, memory optimization, PDF conversion.
  </Card>
</CardGrid>
