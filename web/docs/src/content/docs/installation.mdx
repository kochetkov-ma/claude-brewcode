...
<Steps>
  ...
  <li class="step step-primary">
    <div>
      ...
      <pre><a href="/brewtools/skills/task-board-init/"><code>/brewtools:task-board-init</code></a></pre>
      <p>It analyzes the repo and deploys a file-based Kanban plus a generated <code>/task-spec</code> skill for per-task specs. Follow it with <a href="/brewcode/skills/superreview/"><code>/brewcode:superreview</code></a> to generate a project-tailored deep-review skill.</p>
    </div>
  </li>
</Steps>
...
<CardGrid>
  ...
  <Card title="Brewcode Overview" icon="building" href="/brewcode/overview/">
    Architecture, concepts, all 8 brewcode skills, 5 agents, and 2 hooks.
  </Card>
</CardGrid>
