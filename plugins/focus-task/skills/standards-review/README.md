...
|----------|---------|--------|
| (empty) | `/focus-task:standards-review` | Reviews current branch vs main |
| Commit | `/focus-task:standards-review abc123f` | Reviews specific commit |
| Folder | `/focus-task:standards-review src/main/java` | Reviews folder contents |
| Custom focus | `/focus-task:standards-review -p "check accessibility"` | Adds custom analysis prompt |
...
/focus-task:standards-review abc123f

# Review source folder
/focus-task:standards-review src/components

# Review with custom focus
/focus-task:standards-review -p "focus on error handling"
```
