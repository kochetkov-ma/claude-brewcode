...
```bash
/focus-task:text-optimize [options] [file or folder]
```
...
```bash
# Medium mode (default)
/focus-task:text-optimize CLAUDE.md

# Light mode — safe for critical files
/focus-task:text-optimize -l CLAUDE.md

# Deep mode — max compression
/focus-task:text-optimize -d agents/my-agent.md

# Multiple files in parallel
/focus-task:text-optimize path1.md, path2.md

# Whole directory
/focus-task:text-optimize -d agents/
```
