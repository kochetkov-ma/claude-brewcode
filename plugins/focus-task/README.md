...
/focus-task-setup                           # Через симлинк (автодополнение)
```
...
- Создает симлинки для автодополнения `/focus-task-*`
...
- `~/.claude/skills/focus-task-*` — 6 симлинков
...
- `~/.claude/skills/focus-task-*` симлинки
...
/focus-task-create "Добавить REST API для пользователей"
```
...
/focus-task-review "Безопасность и SQL-инъекции"
```
...
/focus-task-doc "создать документацию для сервисов"
```
