...
/brewdoc:guide agents-catalog   # All 8 agents
```
...
| B: Core Workflow | skills-catalog | All 26 skills with trigger examples |
| C: Mastery | agents-catalog | All 8 agents with roles and model selection |
