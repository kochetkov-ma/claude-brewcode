<!-- think-short brewcode-meta: version=5.5.3 generated_by=brewtools:think-short-setup -->
...
Plan the complete edit set, then execute it. Before writing anything new, find the closest well-built counterpart in the repo and take its principles, in addition to conventions and docs, never instead.
