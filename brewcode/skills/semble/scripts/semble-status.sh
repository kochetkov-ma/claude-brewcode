#!/usr/bin/env bash
# semble-status.sh - read-only status/doctor for the brewcode:semble skill.
#
...
if (verdict === "ready") {
  ...
  nextStep = "Reload Claude Code (new session), then run: /brewcode:semble resume\nCheckpoint: " + stateFile;
  ...
  nextStep = "Fix by hand, then re-run /brewcode:semble status: " + bad;
} else if (verdict === "error") {
  nextStep = "Run /brewcode:semble setup to repair";
} else if (verdict === "disabled") {
  nextStep = "Run /brewcode:semble enable";
} else if (verdict === "verifying") {
  nextStep = "Run /brewcode:semble resume";
} else {
  nextStep = "Run /brewcode:semble setup";
}
