...
Trace via versionless project-local `.claude/teams/{TEAM_NAME}/trace-ops.sh`; T/trace-ops.sh; optional Bash once; `!=` retry/plugin root/env. Missing/fail -> skip; update/move/uninstall safe.
...
Actual scale; !=imagined load/speculative (10-user !=lock-contention). Class/module/test -> nearest .claude/convention/ etalon; additive to rules/conventions/docs, !=replace.
