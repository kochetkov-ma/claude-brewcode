...
> Version: 5.3.0 | Files: 149 | Directories: 44 (excludes the generated `.codex/` mirror; no dotfiles, `__pycache__`, or `node_modules` exist under `brewcode/`)
...
│   └── plugin.json                            # Manifest (name, version 5.3.0, skills/ reference)
│
...
└── package.json                               # npm: claude-plugin-brewcode@5.3.0, build/publish scripts
```
