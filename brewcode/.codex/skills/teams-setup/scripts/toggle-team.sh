...
# also what keeps every path canonically inside `.codex/agents/`. Same guard in verify-team.sh and in
  ...
  while IFS= read -r line; do
    ...
    case "$line" in
      "|"*)
        ...
        # `.codex/agents/<name>.toml` is a PROJECT-GLOBAL namespace, not this team's private slot.
